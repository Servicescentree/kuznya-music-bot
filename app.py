...
def handle_admin_users(message):
    ...
    bot.send_message(config.ADMIN_ID, txt, parse_mode="HTML")
...
def handle_admin_broadcast(message):
    bot.send_message(config.ADMIN_ID, "✍️ Відправте текст розсилки. Всі користувачі отримають це повідомлення.")
